 ...
 * @Last Modified time: 2021-01-22 16:15:34
 */
</script>
<template>
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="buildMan" label="成员人数" align="center" />
        ...
        <el-table-column prop="startTime" label="组建时间" width="140" align="center" />
        <el-table-column prop="endTime" label="结项时间" width="140" align="center" />
        <!-- <el-table-column prop="checkStatus" label="审核状态" width="" align="center" /> -->
        ...
        <el-form :model="addForm" size="small" label-width="140px" label-position="center">
          ...
          <el-row>
            <el-col :xs="24" class="btn" style="text-align:right; margin-bottom:10px;">
              ...
              <el-button type="primary" size="small" icon="el-icon-download" @click="testclick">专家导入</el-button>
            </el-col>
      ...
      <div class="dialog-body">
        <el-form :model="addForm" size="small" label-width="140px">
          <el-collapse v-model="activeName" accordion>
            ...
            <el-collapse-item name="2" title="评价工作任务信息">
              <el-row>
                <table class="detail-table" style="margin-bottom:18px;">
                  <tr>
                    <td>序号</td>
                  ...
                  <tr v-for="(item, index) in detailForm.taskArr" :key="item.taskId">
                    <td width="5%">{{ index + 1 }}</td>
                    <td>{{ item.taskDes }}</td>
                    <td width="30%">{{ item.completeTime }}</td>
                    <td width="10%">{{ item.continueTime }}</td>
                    <td width="10%">{{ item.taskMan }}</td>
                  </tr>
                </table>
              </el-row>
              <el-row>
              ...
              <el-row>
                <div>
                  <div style="margin-bottom:18px;">绩效评价调研函</div>
  ...
  data() {
    return {
      ...
      list: [
        {
          id: 1,
          workGroupName: '天津市滨海新区财政局内控管理系统建设项目-工作组',
          ...
          projectOutLeader: '李宁',
          status: 2,
          startTime: '2020-12-01 11:28:12',
          endTime: '',
          checkStatus: '待审核',
          children: [{
            id: 11,
            workGroupName: '天津市滨海新区财政局预算管理系统项目-工作组',
            workGroupNo: 'G-2020-001',
            buildTime: '2020-12-01 11:28:12',
            buildMan: '马辉',
            ...
            id: 12,
            workGroupName: '浙江省科学技术厅管理系统项目-工作组',
            workGroupNo: 'G-2020-001',
            buildTime: '2020-12-01 11:28:12',
            buildMan: '马辉',
            projectNo: '2020-07714-01-Z02',
            projectName: '2020-07714-01-Z02-浙江省科学技术厅管理系统项目-一般公共预算项目绩效评价',
            clientName: '天津市滨海新区财政局',
            riskLevel: 3,
            partner: '贾立华',
            projectManager: '马辉',
            ...
            buildTime: '2020-12-01 11:28:12',
            buildMan: '马辉',
            projectNo: '2020-07714-01-Z03',
            projectName: '2020-07714-01-Z03-天津市滨海新区财政局-一般公共预算项目绩效评价',
            clientName: '天津市滨海新区财政局',
            riskLevel: 3,
            partner: '贾立华',
            projectManager: '马辉',
        ...
        taskArr: [
            {
              taskId: 1,
              taskDes: '',
              completeTime: '2020-12-12 09:00:00 至 2020-12-15 08:59:59',
              continueTime: '3天',
              taskMan: '朱晓琳'
            }, {
              taskId: 2,
              taskDes: '',
              completeTime: '2020-12-12 09:00:00 至 2020-12-16 08:59:59',
              continueTime: '4天',
              taskMan: '朱晓琳'
            }
          ],
