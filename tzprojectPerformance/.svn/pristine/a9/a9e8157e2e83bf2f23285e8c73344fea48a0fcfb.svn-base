  ...
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <!-- <el-table-column prop="clientName" label="底稿设计" width="120" align="center">
          <template>
        ...
        <div style="flex:2; width:70%">
          <el-form :model="addForm" size="small" label-width="140px">
            <el-collapse v-model="checkCut" accordion>
              ...
              <el-collapse-item title="底稿设计表头信息" name="2">
                <div class="table-list">
                  <el-table
                    v-loading="listLoading"
                    :data="threeList"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addCommonShow = false">关 闭</el-button>
      </span>
    </el-dialog>
    <!--审批-->
    <el-dialog
