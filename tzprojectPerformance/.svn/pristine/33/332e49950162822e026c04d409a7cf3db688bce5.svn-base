  ...
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="projectName" label="项目名称" width="330" align="center" />
        ...
        <el-table-column prop="designMan" label="编写人" width="70" align="center" />
        ...
        <el-table-column prop="status" label="审批状态" width="70" align="center">
          <template slot-scope="scope">
        ...
        <div style="flex:4">
          <el-form :model="addForm" size="small" label-width="140px">
            <el-collapse v-model="checkCut" accordion>
              ...
              <el-collapse-item title="工作总结信息" name="2">
                <el-row>
                  <el-col :sm="24" :md="24">
