<template>
    ...
    <div class="header-operation">
      <el-button type="primary" size="small" @click="handelAdd" icon="el-icon-edit">新增</el-button>
    </div>
    <!--子项目列表-->
    ...
    <!-- 新增子项目弹窗 -->
    <el-dialog  @close="closeDialog" width="50%" class="dialog" :title="title" :visible.sync="addShow">
      ...
      <div class="pagination-container">
        <el-pagination @size-change="handleSizeChange" background @current-change="handleCurrentChange" :current-page="parentListQuery.current"
          :page-sizes="[10,20,30, 50]" :page-size="parentListQuery.size" layout="total, sizes, prev, pager, next, jumper"
          :total="parentTotal">
        </el-pagination>
      </div>
      </div>
          ...
          <el-row>
            ...
            <el-row v-if="addForm.companyType==1">
              ...
              <el-col :xs="24" class="btn" style="text-align:center;">
				        <el-button type="parmary" icon="el-icon-plus" circle @click="timeAdd"></el-button>
			        </el-col>
            </el-row>
            <el-col :sm="24" :md="12">
            ...
            <el-col :sm="24" :md="12">
              <el-form-item label="风险级别">
                <el-select placeholder="请选择" v-model="addForm.riskLevel">
