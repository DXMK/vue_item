<template>
    ...
    <div class="table-list">
      <el-table
        ...
        <el-table-column prop="partner" label="项目负责合伙人" align="center"></el-table-column>
        <el-table-column prop="projectManager" label="项目经理"  align="center"></el-table-column>
        <el-table-column prop="projectAid" label="项目秘书"  align="center"></el-table-column>
        <el-table-column prop="projectOutLeader" label="项目外勤主管"  align="center"></el-table-column>
        <el-table-column prop="projectOutCrew" label="项目组员"  align="center"></el-table-column>
          ...
          <el-row>
            ...
            <el-col :sm="24" :md="12">
              <el-form-item label="子项目编号">
                <el-input size="small" placeholder="由子项目名称带出"
                  disabled="disabled"></el-input>
              </el-form-item>
            </el-col>
            <el-col :sm="24" :md="12">
