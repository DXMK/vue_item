<template>
  <div class="page-container">
    <div class="table-list-search">
      <el-form :model="listQuery" ref="listQuery" inline>
        <el-form-item label="用户姓名" prop="userName">
          <el-input size="small" v-model="listQuery.userName"></el-input>
        </el-form-item>
        <el-form-item label="认证状态" prop="authentication">
          <el-select size="small" v-model="listQuery.authentication" placeholder="请选择">
        ...
        <el-form-item>
          ...
          <el-button @click="searchBoxShow" v-text="bottomSearchBoxShow?'收起':'更多选项'" class="moreSearch" type="text"></el-button>
        </el-form-item>
        <el-collapse-transition>
          <div v-show="bottomSearchBoxShow">
            <el-form-item label="车牌号" prop="carNo">
              <el-input size="small" v-model="listQuery.carNo"></el-input>
            </el-form-item>
          </div>
        </el-collapse-transition>
      </el-form>
    ...
    <el-dialog
      ...
      <el-scrollbar wrapClass="dialog-scroll">
          ...
          <el-row>
            ...
            <el-col :sm="24" :md="12">
              <el-form-item label="用户编号" prop="authentication">
                <el-select size="small" v-model="addForm.authentication">
                  <el-option
                    :key="index"
                    v-for="(item,index) in authenticationList"
                    :label="item.name"
    ...
    <!--导入-->
    <ImportFile :isShow.sync="importShow" :downloadurl="downloadurl" :upLoadUrl="upLoadUrl" :getListFun="getList"></ImportFile>
