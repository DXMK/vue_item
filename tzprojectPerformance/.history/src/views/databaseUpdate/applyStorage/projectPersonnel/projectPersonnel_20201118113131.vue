  ...
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="test6" label="学历" align="center" />
        <el-table-column prop="test6" label="专业" align="center" />
        <el-table-column prop="test6" label="是否为主评人" align="center" />
        <el-table-column prop="test6" label="项目类型（业务类型）" align="center" />
        <el-table-column prop="test6" label="曾担任项目角色" align="center" />
        <el-table-column prop="test6" label="年限+经验" align="center" />
