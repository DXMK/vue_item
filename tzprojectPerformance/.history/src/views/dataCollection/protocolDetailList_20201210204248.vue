 ...
 * @Last Modified time: 2020-12-09 11:38:21
 */
</script>
<template>
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="dataDetailList" label="资料清单名称" width="330" align="center" />
        <el-table-column prop="buildMan" label="拟定人" width="" align="center" />
        <el-table-column prop="approvalTime" label="拟定时间" width="" align="center" />
    ...
    >
      <div class="dialog-body">
        <el-form :model="addForm" size="small" label-width="120px" label-position="center">
          ...
          <el-row>
            <strong>清单拟定信息</strong>
          </el-row>
          <el-divider />
          <el-row>
            <div style="margin-left:10px;margin-bottom:10px;">已上传资料清单列表</div>
            <div class="table-list">
              <el-table
                v-loading="listLoading"
                :data="fileUploadList"
