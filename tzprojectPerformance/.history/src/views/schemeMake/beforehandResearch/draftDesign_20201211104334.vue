            ...
            <el-row>
              <div class="table-list">
                ...
                >
                  ...
                  <!-- <el-table-column prop="threeScore" label="分值" width="10" align="center" />
                  <el-table-column prop="indexExplain" label="指标解释" width="10" align="center" />
                  <el-table-column prop="indexDescription" label="指标说明" width="10" align="center" />
