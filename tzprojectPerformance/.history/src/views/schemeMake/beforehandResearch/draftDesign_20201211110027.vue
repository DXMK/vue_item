            ...
            <el-row>
              <div class="table-list">
                ...
                >
                  ...
                  <el-table-column prop="scoreRule" label="评价标准及评分规则" width="100" align="center" />
                  <el-table-column prop="appraiseScore" label="评价得分" width="100" align="center" />
                  <!-- <el-table-column prop="deductionDes" label="扣分说明" width="100" align="center" /> -->
                  <!-- <el-table-column prop="indexComplete" label="指标完成情况" width="100" align="center" />
                  <el-table-column prop="checkObj" label="考核对象" width="100" align="center" />
