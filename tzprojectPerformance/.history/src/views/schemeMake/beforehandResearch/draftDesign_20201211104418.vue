  ...
  <div class="page-container">
    ...
    >
      <div class="dialog-body" style="display:flex;">
        <div style="flex:4">
          <el-form :model="addForm" inline size="small" label-width="180px" label-position="center">
            <el-row>
              <strong>项目信息</strong>
            </el-row>
            <el-divider />
            ...
            <el-row>
              <div class="table-list">
                <el-table
                  ...
                  @selection-change="handleSelectionChange"
                >
                  <el-table-column type="index" :index="typeIndex" label="序号" fixed="left" width="100" align="center" />
                  <el-table-column prop="threeIndex" label="三级指标" align="center" width="100" />
                  <el-table-column prop="threeScore" label="分值" width="100" align="center" />
                  <el-table-column prop="indexExplain" label="指标解释" width="150" align="center" />
                  <el-table-column prop="indexDescription" label="指标说明" width="100" align="center" />
                  <!-- <el-table-column prop="scoreRule" label="评价标准及评分规则" width="10" align="center" />
                  <el-table-column prop="appraiseScore" label="评价得分" width="10" align="center" />
                  <el-table-column prop="deductionDes" label="扣分说明" width="10" align="center" />
                  <el-table-column prop="indexComplete" label="指标完成情况" width="10" align="center" />
                  <el-table-column prop="checkObj" label="考核对象" width="10" align="center" />
                  <el-table-column prop="findProblem" label="发现问题" width="10" align="center" />
                  <el-table-column prop="dataFrom" label="数据来源" width="10" align="center" />
                  <el-table-column prop="remark" label="备注" width="10" align="center" /> -->
                  <!-- <el-table-column align="center" label="操作" width="10" fixed="right">
                    <template slot-scope="scope">
                      <el-button
                        size="small"
                        plain
