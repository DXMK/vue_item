  ...
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="evaluateIndex" label="评价过程类—预调研资料" align="center">
          <!-- <template>
            <el-button type="primary" size="small" @click="importShow=true">上传</el-button>
          </template> -->
        </el-table-column>
        <el-table-column prop="evaluateIndex" label="评价过程类—评价实施资料" align="center">
          <!-- <template>
            <el-button type="primary" size="small" @click="importShow=true">上传</el-button>
          </template> -->
        </el-table-column>
        <el-table-column prop="evaluateIndex" label="评价结果类" align="center">
          <!-- <template>
            <el-button type="primary" size="small" @click="importShow=true">上传</el-button>
          </template> -->
        </el-table-column>
        <el-table-column prop="evaluateIndex" label="其他类" align="center">
          <!-- <template>
            <el-button type="primary" size="small" @click="importShow=true">上传</el-button>
          </template> -->
        </el-table-column>
