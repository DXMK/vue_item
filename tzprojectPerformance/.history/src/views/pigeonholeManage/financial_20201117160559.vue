  ...
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <!-- <el-table-column prop="UploadRecord" label="工作档案-财政部项目" align="center" /> -->
        <el-table-column align="center" label="工作档案-财政部项目" fixed="right">
          <template slot-scope="scope">
            <el-upload
              ...
              :file-list="fileList"
            >
              <el-button v-if="scope.row.status === 1" size="small" type="primary">点击上传</el-button>
            </el-upload>
          </template>
        </el-table-column>
      </el-table>
