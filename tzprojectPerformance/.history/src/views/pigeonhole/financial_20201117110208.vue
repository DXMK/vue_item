  ...
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="evaluateReport" label="归档模板" align="center" />
        <el-table-column prop="UploadReport" label="上传工作档案-财政部项目" align="center" />
...
export default {
  ...
  data() {
    return {
      ...
      list: [
        {
          evaluateReport: '归档模板一',
          UploadReport: ''
        },
        {
          evaluateReport: '归档模板二',
          UploadReport: ''
        }, {
          evaluateReport: '归档模板三',
          UploadReport: ''
        }
      ],
      total: null,
