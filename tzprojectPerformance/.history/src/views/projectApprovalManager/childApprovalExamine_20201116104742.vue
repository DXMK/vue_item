      ...
      >
        ...
        <el-table-column prop="projectType" label="项目类型" align="center">
          <template slot-scope="scope">
            <span v-if="scope.row.projectType === 1" style="color: #5CB89D"
              >类型A</span
            >
            <span v-if="scope.row.projectType === 2" style="color: red"
              >类型B</span
            >
          </template>
        </el-table-column>
        ...
        <el-table-column prop="status" label="状态" align="center">
          <template slot-scope="scope">
            ...
            <span v-if="scope.row.status === 4" style="color: green"
              >已审批</span
            >
          </template>
        </el-table-column>
        ...
        >
          <el-row>
            ...
            <el-row v-if="addForm.companyType == 1">
              <div
                v-for="item in addForm.childProjectArr"
                :key="item.childProjectNo"
              >
                <el-col :sm="24" :md="12">
