<template>
    ...
    <div class="table-list-search">
      <el-form :model="listQuery" ref="listQuery" inline>
        <el-form-item label="专家名称" prop="companyName">
          <el-input size="small" v-model="listQuery.expertName"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div class="table-list">
      <el-table
        ...
        <el-table-column prop="expertType" label="专家类型" align="center"></el-table-column>
        <el-table-column prop="studyDirection" label="研究方向" align="center"></el-table-column>
