...
export const asyncRoutes = [
  ...
  // 数据库更新
  {
    path: '/databaseUpdate',
    component: Layout,
    redirect: '/databaseUpdate/menu1/menu1-1',
    alwaysShow: true, // will always show the root menu
    name: 'databaseUpdate',
    meta: {
      title: '数据库更新',
    ...
    children: [
      {
        path: 'menu1',
        component: () => import('@/views/databaseUpdate/menu1/index'),
        name: 'Menu1',
        meta: {
          title: '数据库入库申请',
          roles: ['admin'] // or you can only set roles in sub nav
        ...
        children: [
          {
            path: 'menu1-1',
            component: () => import('@/views/databaseUpdate/menu1/menu1-1/index'),
            name: 'Menu1-1',
            meta: { title: 'Menu 1-1' }
          },
          {
            path: 'menu1-2',
            // component: () => import('@/views/databaseUpdate/menu1/menu1-2'),
            name: 'Menu1-2',
            // redirect: '/databaseUpdate/menu1/menu1-2/menu1-2-1',
            meta: { title: 'Menu 1-2' },
            children: [
              // {
              //   path: 'menu1-2-1',
              //   component: () => import('@/views/databaseUpdate/menu1/menu1-2/menu1-2-1'),
              //   name: 'Menu1-2-1',
              //   meta: { title: 'Menu 1-2-1' }
              // },
              // {
              //   path: 'menu1-2-2',
              //   component: () => import('@/views/databaseUpdate/menu1/menu1-2/menu1-2-2'),
              //   name: 'Menu1-2-2',
