    ...
    children: [
      {
        ...
        redirect: '/databaseUpdate/menu1/policylaw',
        children: [
          {
            path: 'policylaw',
            component: () => import('@/views/databaseUpdate/menu1/policylaw/policylaw'),
            name: 'policylaw',
            meta: { title: '政策法规库' }
          },
          {
            path: 'perforIndex',
            component: () => import('@/views/databaseUpdate/menu1/perforIndex/perforIndex'),
            name: 'perforIndex',
            meta: { title: '绩效指标库' }
          }
        ]
