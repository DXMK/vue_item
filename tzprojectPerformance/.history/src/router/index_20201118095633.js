...
export const asyncRoutes = [
  ...
  // 归档管理
  {
    ...
    children: [
      ...
      {
        path: 'approvalFinancial',
        name: 'approvalFinancial',
        component: () => import('@/views/pigeonholeManage/approvalFinancial'),
        meta: {
          title: '工作档案-财政部审核',
          roles: ['admin'] // or you can only set roles in sub nav
        }
      },
      {
        path: 'approvalOther',
        name: 'approvalOther',
        component: () => import('@/views/pigeonholeManage/approvalOther'),
        meta: {
          title: '工作档案-其他项目审核',
          roles: ['admin'] // or you can only set roles in sub nav
        }
  ...
  // 数据库更新
  {
    path: '/databaseUpdate',
    component: Layout,
    redirect: '/databaseUpdate/applyStorage',
    alwaysShow: true, // will always show the root menu
    name: 'databaseUpdate',
    meta: {
      title: '数据库更新',
    ...
    children: [
      {
        path: 'applyStorage',
        component: () => import('@/views/databaseUpdate/applyStorage'),
        name: 'applyStorage',
        meta: {
          title: '数据库入库申请',
          roles: ['admin'] // or you can only set roles in sub nav
        },
        redirect: '/databaseUpdate/applyStorage/policylaw',
        children: [
          {
            path: 'policylaw',
            component: () => import('@/views/databaseUpdate/applyStorage/policylaw/policylaw'),
            name: 'policylaw',
            meta: { title: '政策法规库' }
          },
          {
            path: 'perforIndex',
            component: () => import('@/views/databaseUpdate/applyStorage/perforIndex/perforIndex'),
            name: 'perforIndex',
            meta: { title: '绩效指标库' }
          },
          {
            path: 'projectPersonnel',
            component: () => import('@/views/databaseUpdate/applyStorage/projectPersonnel/projectPersonnel'),
            name: 'projectPersonnel',
            meta: { title: '项目人员库' }
          },
          {
            path: 'projectSpecialist',
            component: () => import('@/views/databaseUpdate/applyStorage/projectSpecialist/projectSpecialist'),
            name: 'projectSpecialist',
            meta: { title: '项目专家库' }
          },
          {
            path: 'projectPerformance',
            component: () => import('@/views/databaseUpdate/applyStorage/projectPerformance/projectPerformance'),
            name: 'projectPerformance',
            meta: { title: '项目业绩库' }
          },
          {
            path: 'projectCase',
            component: () => import('@/views/databaseUpdate/applyStorage/projectCase/projectCase'),
            name: 'projectCase',
            meta: { title: '项目案例库' }
          }
        ]
