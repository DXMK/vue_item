...
export const asyncRoutes = [
  ...
  // 数据库更新
  {
    path: '/databaseUpdate',
    component: Layout,
    redirect: '/databaseUpdate/storage1_1/storage',
    alwaysShow: true, // will always show the root menu
    name: 'databaseUpdate',
    meta: {
      title: '数据库更新',
    ...
    children: [
      {
        path: 'storage1_1',
        component: () => import('@/views/databaseUpdate/storage1_1/index'),
        name: 'storage1_1',
        meta: {
          title: '数据库入库申请',
          roles: ['admin'] // or you can only set roles in sub nav
        ...
        children: [
          {
            path: 'storage',
            component: () => import('@/views/databaseUpdate/storage1_1/storage'),
            name: 'storage',
            meta: { title: '入库一' }
          }
        ]
