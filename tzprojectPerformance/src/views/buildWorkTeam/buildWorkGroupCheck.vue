 ...
 * @Last Modified time: 2021-01-15 17:25:16
 */
</script>
<template>
        ...
        >
          ...
          <el-row>
            <el-col :xs="24" class="btn" style="text-align:right; margin-bottom:10px;">
              <el-button type="primary" icon="el-icon-circle-plus-outline" @click="partAdd">导 入</el-button>
            </el-col>
