...
<template>
  <div class="page-container">
            ...
            <el-row>
              <div class="table-list">
                <!-- <table class="detail-table">
                  ...
                  <tr>
                    <td>XX活动完成率</td>
                    <td>项目实施的实际产出数与计划产出数的比率，用以反映和考核项目产出数量目标的实现程度。</td>
                    <td>评分要点：①活动1；②活动2。</td>
                    <td>分值共10分，得分=实际产出数/计划产出数*100%*分值；计划产出数≥ 8项</td>
                    <td />
                    <td />
                    <td />
                    <td>地方单位</td>
                    <td />
                    <td>活动方案、照片、视频、总结等</td>
                    <td />
                    <td />
                    <td />
                    <td />
      ...
      <div class="dialog-body">
        ...
        <div class="table-list">
          ...
          >
            ...
            <el-table-column prop="indexExplain" label="指标解释" width="160" align="center" />
            <el-table-column prop="indexDescription" label="指标说明" width="160" align="center" />
            <el-table-column prop="scorePoint" label="要点分值" width="160" align="center" />
            <el-table-column prop="scoreRule" label="评价标准及评分规则" width="230" align="center" />
            <el-table-column prop="appraiseScore" label="评价得分" width="" align="center" />
            <el-table-column prop="deductionDes" label="扣分说明" width="140" align="center" />
            <el-table-column prop="indexComplete" label="指标完成情况" width="100" align="center" />
    ...
    >
      <div class="dialog-body">
        <el-form size="small" :model="draftForm" label-width="140">
          <el-row>
            <el-col :span="12">
              <el-form-item label="底稿类型" prop="draftType">
                <el-select v-model="draftForm.draftType">
                  ...
                  <el-option :value="5" label="其他类底稿">其他类底稿</el-option>
                </el-select>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row v-if="draftForm.draftType==1">
            <el-col :sm="24" :md="12">
              <el-form-item label="评价期间年度数" prop="companyName">
                <el-input v-model="draftForm.yearEvaluate" readonly="true" />
              </el-form-item>
            </el-col>
          ...
          <!--其他类-->
          <el-row v-if="draftForm.draftType==5">
            <el-col :sm="24" :md="12" style="margin-top:20px;">
