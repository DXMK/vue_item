  ...
  <div class="page-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="designMan" label="分析人" width="80" align="center" />
        <el-table-column prop="approvalTime" label="汇总分析时间" width="140" align="center" />
        <el-table-column prop="status" label="分析状态" width="80" align="center">
          <template slot-scope="scope">
            <span v-if="scope.row.status === 1">未分析</span>
            <span v-if="scope.row.status === 2">已分析</span>
          </template>
        </el-table-column>
      ...
      <div class="dialog-body">
        <el-form :model="addForm" size="small" label-width="140px">
          <el-collapse v-model="checkCut" accordion>
            ...
            <el-collapse-item title="调研数据汇总信息" name="2">
              <el-row>
                <el-col :sm="24" :md="12">
                  <el-form-item label="调研数据汇总分析">
                    <el-upload
                      class="upload-demo"
